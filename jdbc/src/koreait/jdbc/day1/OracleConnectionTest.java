...
//제일 먼저 해야 할것을 '데이터베이스 연결'입니다.
public class OracleConnectionTest {

	public static void main(String[] args) {

		//0. Connection 은 인터페이스로 직접 객체를 생성하지 않고 
		// 구현클래스가 있어야합니다. db에서는 db드라이버가 접속하려는 db에 종류에 따라
		...
		//oracle.jdbc.driver는 ojdbc6.jar에 포함된 패키지 이름
		...
		}//명시적으로 자원을 close => 당장 실행 시 오류가 안나지만 서버 연결시 문제가 발생할 수 있음.
	}
}
/*
